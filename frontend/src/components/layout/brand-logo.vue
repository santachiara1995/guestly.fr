...
<template>
  <RouterLink
    ...
    :class="[
      ...
      compact ? 'h-9 gap-1.5 py-0' : 'min-h-11 gap-2.5 py-1'
    ]"
  ...
  >
    <span
      :class="[
        ...
        compact ? 'h-[1.68rem] w-[1.68rem] rounded-[0.78rem]' : 'h-9 w-9 rounded-[0.95rem] sm:h-10 sm:w-10'
      ]"
    >
      <svg :class="compact ? 'h-[0.92rem] w-[0.92rem]' : 'h-5.5 w-5.5'" viewBox="0 0 56 56" aria-hidden="true">
    ...
    <div class="leading-[1.01]">
      <p
        :class="[
          ...
          compact ? 'text-[0.8rem] sm:text-[0.84rem]' : 'text-[0.96rem] sm:text-[1rem]'
        ]"
      >
        CITYZ'France
      </p>
