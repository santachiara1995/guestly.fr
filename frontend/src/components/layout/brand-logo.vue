  ...
  >
    <span
      :class="[
        ...
        compact ? 'h-[1.55rem] w-[1.55rem] rounded-[0.72rem]' : 'h-9 w-9 rounded-[0.95rem] sm:h-10 sm:w-10'
      ]"
    >
      <svg :class="compact ? 'h-[0.86rem] w-[0.86rem]' : 'h-5.5 w-5.5'" viewBox="0 0 56 56" aria-hidden="true">
    ...
    <div class="leading-[1.01]">
      <p
        :class="[
          ...
          compact ? 'text-[0.76rem] sm:text-[0.8rem]' : 'text-[0.96rem] sm:text-[1rem]'
        ]"
      >
        CITYZ'France
      </p>
